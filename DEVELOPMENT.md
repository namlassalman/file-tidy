...
- [x] Generate a separate Backup Sync HTML report with backup health, ranked folder gaps, working status filters, and bounded drill-down evidence for copy, relocation, conflict, recovery, and already-backed-up states.
